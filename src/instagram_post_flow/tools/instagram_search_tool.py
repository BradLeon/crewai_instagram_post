...
class InstagramSearchToolSchema(BaseModel):
    """Input for InstagramSearchTool."""
...
class InstagramSearchTool(BaseTool):
    ...
    args_schema: Type[BaseModel] = InstagramSearchToolSchema
    ...
    def _run(self, **kwargs: Any) -> Any:
        ...
        # 限制站点为instagram
        search_query = f"site:instagram.com {search_query}"
